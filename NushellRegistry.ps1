# 已弃用
# https://github.com/nushell/nushell/issues/10060
# Here is a script that can register Nushell or remove previous registration of Nushell.
# Copy content to NushellRegistry.ps1 and run as admin
# And run `NushellRegistry.ps1 -Register` or `NushellRegistry.ps1 -Remove`
# If you installed Nushell with winget you can run it directly, otherwise make sure to fix path before
...
# $Nushell_Ico = '"/path/to/you/icon"'
# $Nushell_Command = '"/path/to/you/nu.exe" "%1" "%*"'
